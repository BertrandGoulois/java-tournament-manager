package com.tournament.tournament_manager.infrastructure.rpc;
...
public abstract class AbstractJsonRpcHandler implements JsonRpcMethodHandler {
    ...
    /**
     * Convertit les paramètres bruts de la requête JSON-RPC vers le type attendu par le handler.
     *
     * @param params      les paramètres bruts (map, string, etc.)
     * @param targetClass le type cible
    ...
    /**
     * Extrait un paramètre de type {@code Long} depuis les paramètres bruts de la requête.
     *
