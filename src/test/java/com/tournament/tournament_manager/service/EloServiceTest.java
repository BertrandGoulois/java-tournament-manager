...
class EloServiceTest {
    ...
    void updateElo_shouldIncreaseWinnerElo() {
        ...
        winner.setEloRating(1000);
        Player loser = new Player();
        loser.setEloRating(1000);
        ...
        assert winner.getEloRating() > 1000;
        assert loser.getEloRating() < 1000;
    }
    ...
    void updateElo_shouldGiveMoreEloWhenBeatingStrongerOpponent() {
        ...
        assert winner.getEloRating() > 1016;
    }
}